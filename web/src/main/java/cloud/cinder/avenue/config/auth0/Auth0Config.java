package cloud.cinder.avenue.config.auth0;
...
public class Auth0Config extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(final HttpSecurity http) throws Exception {
        ...
        http.addFilterAfter(loginRefererFilter(), SecurityContextPersistenceFilter.class);
    ...
    @Bean
    public LoginRefererFilter loginRefererFilter() {
        return new LoginRefererFilter();
    }
